...
public class InMemoryAuctionService implements AuctionService{
	...
	Auction a = new Auction(1, "Computer", "a device used for computing", 10, 5, new Date());
	Auction a1 = new Auction(2, "Bag", "an item used for holding other items like a queue", 7, 9, new Date());
	Auction a2 = new Auction(3, "Television", "a device that can serve as a monitor or source of entertainment", 18, 8, new Date());
